...
ENGLISH_QUESTIONS = [
  ...
  { description: 'What is the latest version of Ruby 3.2 series (stable) as of 2024-05-15 00:00 (JST)?', choices: ['3.0.7', '3.1.5', '3.2.4', '3.3.1'], answerIndex: 2, explanation: 'The latest version of Ruby 3.2 series (stable) as of 2024-05-15 00:00 (JST) is 3.2.4.' },
  { description: 'What is the latest version of Ruby 3.1 series (stable) as of 2024-05-15 00:00 (JST)?', choices: ['3.0.7', '3.1.5', '3.2.4', '3.3.1'], answerIndex: 1, explanation: 'The latest version of Ruby 3.1 series (stable) as of 2024-05-15 00:00 (JST) is 3.1.5.' },
